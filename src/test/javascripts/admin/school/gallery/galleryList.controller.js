(function () {
    ...
    angular
        .module('app.school')
        .controller('SchoolGalleryList', SchoolGalleryList);

    SchoolGalleryList.$inject = [
        'logger', 'datacontext', 'NgTableParams', '$filter', 'swal'
    ];

    /* @ngInject */
    function SchoolGalleryList(logger, datacontext, NgTableParams, $filter, swal) {
        ...
        /* Methods */
        function activate(){
            logger.debug('Admin > School > Gallery > List > Loaded');
            //makeTable();
        }
