(function () {
    ...
    angular
        .module('app.school')
        .controller('SchoolCertificateList', SchoolCertificateList);

    SchoolCertificateList.$inject = [
        'logger', 'datacontext', 'NgTableParams', '$filter', 'swal'
    ];

    /* @ngInject */
    function SchoolCertificateList(logger, datacontext, NgTableParams, $filter, swal) {
        ...
        /* Methods */
        function activate(){
            logger.debug('Admin > School > Certificate > List > Loaded');
            //makeTable();
        }
